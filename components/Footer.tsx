    ...
    return (
        ...
        >
            ...
            <style
                ...
                dangerouslySetInnerHTML={{
                    __html:
                        ".NewsletterSignupFooter{display:block;background:#f4f4f4;padding:30px 15px}.NewsletterSignupFooter_Component{margin:30px auto;min-height:42px;max-width:454px}.NewsletterSignupFooter_Disclaimer{max-width:454px;margin:0 auto}.NewsletterSignupFooter_Disclaimer a,.NewsletterSignupFooter_Disclaimer a:hover,.NewsletterSignupFooter_Disclaimer a:visited,.NewsletterSignupFooter_Disclaimer a:active{color:#725038}@media (min-width: 1280px){.NewsletterSignupFooter_Heading{line-height:2.5rem;font-size:1.75rem}}\n"
                }}
            />
            <div className="NewsletterSignupFooter">
                <h2 className="NewsletterSignupFooter_Heading br_text-2xl-serif br_text-center ">
                Get exclusive access to my latest sessions, special offers, and meaningful surprises.
                </h2>
            ...
            <section className="SiteFooter__wrapper" id="footer">
                    ...
                    >
                        <ul>
                            ...
                            <li>
                                <a
                                    target="_blank"
                                    href="https://www.instagram.com/cheikhmedlej313"
                                    data-auto-id="true"
                                    id="page-footer-http-www-instagram-com-bellroy-1"
                                >
                                    <svg
              ...
              C35.3,13.3,35.3,13.3,35.3,13.3z"
                            ...
                            <li>
                                <a
                                    target="_blank"
                                    href="https://www.facebook.com/share/1CEN3ZL1B4/?mibextid=wwXIfr"
                                    data-auto-id="true"
                            ...
                            <li>
                                <a
                                    target="_blank"
                                    href="https://www.tiktok.com/@sheikhmedlej"
                                    data-auto-id="true"
                        ...
                        <div className="text">
                            <div className="column mb-5"  >
                                <p className="question">
                                    ...
                                    <span>
                                        Contact{" "}
                                        <a
                                            href="mailto:medlej333@gmail.com"
                                            data-auto-id="true"
                            ...
                            <div className="column">
                                <span className="copyright">
                                    All rights reserved © {(new Date().getFullYear())} sheikh medlej
                                </span>
                            </div>
                        </div>
                    </div>
